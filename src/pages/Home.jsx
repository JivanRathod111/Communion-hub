    ...
    <div className="relative">
      ...
      >
        ...
        <p className="text-sm mb-6 drop-shadow-md max-w-3xl">
          Communion Hub is a revolutionary platform designed to unite people through faith, culture, and shared interests. Whether you seek spiritual guidance, meaningful events, or like-minded individuals, our hub provides an inclusive space where everyone feels valued, respected, and connected.
        </p>
      ...
      <Link to="/about">
        <motion.img
          ...
          className="absolute top-20 left-10 w-24 animate-bounce z-30"
          animate={{ y: [0, 10, 0] }}
          transition={{ repeat: Infinity, duration: 3, ease: "easeInOut" }}
        />
      </Link>

      {/* Why Choose Communion Section */}
      <motion.section className="py-12 px-6 bg-gray-100" {...fadeInAnimation}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
          <motion.div className="h-80 bg-white p-18 rounded-xl shadow-lg border-l-4 border-blue-500 z-10" {...fadeInAnimation}>
          ...
          <motion.div className="bg-gradient-to-r from-blue-500 to-cyan-400 p-18 rounded-xl shadow-lg text-white z-10" {...fadeInAnimation}>
          ...
          <motion.div className="p-18 bg-white rounded-xl shadow-lg border-t-4 border-cyan-400 hover:shadow-2xl transition z-10" {...fadeInAnimation}>
